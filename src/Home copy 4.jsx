          ...
          <div id="smooth-content">
            ...
            <img src='plate.svg'></img>
              ...
              <div className="middleBox">     
                ...
                <div className="textLineLeft"> OASIS  OASIS  OASIS  OASIS  OASIS </div>
                <div className="textLineLeft"> OASIS  OASIS  OASIS  OASIS  OASIS </div>                          
                <div className="dinnerPlan">
                  <div className="h1"> Do you have  dinner plan? </div>
                  <div className="h3">Great atmosphere for dining in </div>
                  <div className="h5"> Book a Table </div>
                </div>
                <div className="textLineRight"> OASIS  OASIS  OASIS  OASIS  OASIS </div>
                <div className="textLineRight"> OASIS  OASIS  OASIS  OASIS  OASIS </div>              
                </div>    
              </div>
            </div>
            ...
            <div className="container mx-auto "> 
            <div class="flex flex-row gap-2 offer ">
